...
const validation = validations.post();
...
router
  ...
  //#desc Create a post
  //@access Private
  .post("/", [auth, validation], async (req, res) => {
  ...
  //#desc Comment a post
  //@access Private
  .post("/comment/:id", [auth, validation], async (req, res) => {
    const errors = validationResult(req);
    hasErrors(res, errors);
  ...
  .put("/like/:id", auth, async (req, res) => {
    try {
      const post = await Post.findById(req.params.id);
      //check if post like allready post
      if (
  ...
  //@access Private
  .delete("/comment/:id/:comment_id", auth, async (req, res) => {
    try {
      const post = await Post.findById(req.params.id);
      //Pull out comment
